        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header card-header-primary">
              ...
              <p class="card-category">Untuk mengisi data jenis sales
            ...
            <!-- lihat sini -->
            <form method="POST" action="{{ url('jenissales') }}">
              {{ csrf_field() }}
            <div class="card-body">
              <div class="row">
                <!-- lnnkkjhkhk -->
                <table style="width:100%; margin-left: 30px; margin-right: 550px;">
                  <tr>
                    <th>Nama Jenis Sales</th>
                    <td><input type="text" name="jenissales" autofocus></td>
                  </tr>
                  <tr>
                    <th>Persentase</th>
                    <td><input type="double" name="persentasesales" value="0"></td>
                  </tr>
                </table>
