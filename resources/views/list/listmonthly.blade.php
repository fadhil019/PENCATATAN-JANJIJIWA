        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header card-header-primary">
              ...
              <label class="card-category">Fitur ini untuk melihat list monthly expenses
            ...
            <!-- lihat sini -->
            <!-- lihat sini -->
            <form method="POST" action="{{url('perhitunganmonthly')}}">
              {{ csrf_field() }}
            <div class="card-body">
                  ...
                  @foreach($listmonthlys as $listmonthly)
                    <tr>
                      ...
                      <td>Rp {{ number_format($listmonthly->harga_satuan, 2) }}</td>
                      <td>{{ number_format($listmonthly->total) }}</td>
                      <td>Rp {{ number_format($listmonthly->subtotal, 2) }}</td>
                      <td>
                          <a class="btn btn-success btn-sm" href="{{URL::to('/monthlylist/halamanedit/'.$listmonthly->id_monthlyexpense)}} ">EDIT</a>
                          <a class="btn btn-danger btn-sm" href="{{URL::to('/monthlylist/destroy/'.$listmonthly->id_monthlyexpense)}} ">HAPUS</a>
                      </td>
                    </tr>
                  @endforeach
                </table>
