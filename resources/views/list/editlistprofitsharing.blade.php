      ...
      <div class="content">
        <div class="container-fluid">
          <div class="card">
            ...
            <!-- lihat sini -->
            <form method="GET" action="{{url('profitsharinglist/edit/'.$idprofitsharing)}}">
              {{ csrf_field() }}
            <div class="card-body">
              ...
              <div class="row">
                ...
                <table style="width:100%; margin-left: 30px; margin-right: 500px;">
                  <tr>
                    <th>Pihak</th>
                    <td><input type="text" name="pihak" value="{{ $pihak }}"></td>
                  </tr>
                  <tr>
                    <th>Persentase</th> 
                    <td><input type="double" name="persentase" value="{{ $persentase }}"></td>
                  </tr>
